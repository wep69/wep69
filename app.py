...
def calculate_dris_ibn(df, nutrients):
    ...
    return dris_indices, IBN, df_ratios, df_high_yield, all_variance_ratio_ratios  # Retornar all_variance_ratio_ratios
...
if uploaded_file is not None:
    try:
        ...
        dris_indices, IBN, df_ratios, df_high_yield, all_variance_ratio_ratios = calculate_dris_ibn(df, nutrients)
        ...
        with tab2:
            ...
            if st.button("Executar Bootstrap"):
                ...
                for _ in range(bootstrap_iterations):
                    ...
                    dris_indices_sample, IBN_sample, _, _, _ = calculate_dris_ibn(df_sample, nutrients)
        ...
        with tab5:
            ...
            for nutrient in nutrients:
                ...
                X = dris_indices_high_yield_df[[nutrient]]  # Passar como uma série
                model.fit(X.values.reshape(-1, 1), y)  # Reshape X para formato esperado
            ...
            model_parameters = {
                nutrient: (
                    ...
                    regression_models[nutrient].score(X.values.reshape(-1, 1), y),  # Reshape X para formato esperado
                )
                for nutrient in nutrients
            }
            ...
            if st.button("Executar Bootstrap (Valores de Referência)"):
                ...
                for _ in range(bootstrap_iterations):
                    ...
                    for nutrient in nutrients:
                        ...
                        X = dris_sample  
                        model.fit(X[nutrient].values.reshape(-1, 1), y)  
                ...
                # Correção: A indentação foi corrigida para incluir o st.write dentro do with tab5:
